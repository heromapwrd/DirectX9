...
bool SetUp()
{
	...
	pVertex[0] = Vertex(-1.0f, -1.0f, -1.0f);
	pVertex[1] = Vertex(-1.0f,  1.0f, -1.0f);
	pVertex[2] = Vertex( 1.0f,  1.0f, -1.0f);
	pVertex[3] = Vertex( 1.0f, -1.0f, -1.0f);
	pVertex[4] = Vertex(-1.0f, -1.0f,  1.0f);
	pVertex[5] = Vertex(-1.0f,  1.0f,  1.0f);
	pVertex[6] = Vertex( 1.0f,  1.0f,  1.0f);
	pVertex[7] = Vertex( 1.0f, -1.0f,  1.0f);
	VB->Unlock();
